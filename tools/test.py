...
def main():
    ...
    if rank == 0:
        ...
        if args.eval:
            print(f"DEBUG: args.eval is {args.eval}, entering evaluation section")
            ...
            print(f"DEBUG: Evaluation completed, result: {eval_dict}")
        else:
            print(f"DEBUG: args.eval is {args.eval}, skipping evaluation")
