...
# Replace with your RoScenes root
data_root = '/path/to/RoScenes'
max_cam = 12
num_gpus = 8
batch_size = 1
...
#========MAP=======
with_seg=False #Whether to predict map
...
data = dict(
    ...
    test=dict(type=dataset_type,
        ...
        ann_file=data_root + 'val/s001_split_validation_difficulty_mixed_ambience_day/database/scene.pkl',
